...
class Generator(nn.Module):
    ...
    def __init__(self, z_dim, shared_dim, img_size, g_conv_dim, g_spectral_norm, attention, attention_after_nth_gen_block, activation_fn,
        ...
        conditional_bn = True if conditional_strategy in ["ACGAN", "SSGAN", "OSSSGAN", "NOSSGAN", "ProjGAN", "ContraGAN", "Proxy_NCA_GAN", "NT_Xent_GAN", "Random", "Single", "Open", "Reject"] else False
